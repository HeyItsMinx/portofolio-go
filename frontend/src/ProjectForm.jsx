...
export default function ProjectForm() {
  ...
  const existingProject = location.state?.project; // Edit
  ...
  const handleSubmit = (e) => {
    ...
    const url = existingProject 
      ? `http://localhost:8080/api/project/${existingProject.id}` 
    ...
    <div className="min-h-screen p-8 bg-[radial-gradient(circle_at_top_right,_#1a0000,_#000)] text-white flex justify-center items-center">
      <section className="bg-neutral-950 border-2 border-neutral-900 p-8 -skew-x-[2deg] relative group max-w-4xl w-full">
        ...
        <div className="flex justify-between items-center mb-8 skew-x-[2deg]">
          ...
          <Link to="/" className="text-gray-400 hover:text-white uppercase font-bold text-sm tracking-widest border border-neutral-700 px-4 py-2 hover:border-red-600 transition-colors">
            Abort
          </Link>
        </div>
