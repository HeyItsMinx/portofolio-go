    ...
    <>
      <section className="relative h-screen min-h-[600px] bg-black overflow-hidden flex flex-col justify-center">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-8 text-center">
          ...
          >
            <Link to="/project" className="bg-[var(--blood)] text-black font-black uppercase tracking-widest px-8 py-4 text-sm hover:bg-white transition-colors duration-150">
              View The Vault
            </Link>
            <Link to="/contact" className="border-2 border-white text-white font-black uppercase tracking-widest px-8 py-4 text-sm hover:border-[var(--blood)] hover:text-[var(--blood)] transition-colors duration-150">
              Get In Touch
            </Link>
          </motion.div>
        </div>
